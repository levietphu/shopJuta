                                ...
                                <div class="quick-add-to-cart">
                                    <div class="quantity">
                                        ...
                                        <div class="cart-plus-minus">
                                            <input class="cart-plus-minus-box" type="number" value="1" min="1" max="{{$product_detail->quantity}}" name="qty">
                                        </div>
                                    </div>
                    ...
                    <div class="single-product-wrap">
                        ...
                        <div class="product_desc">
                            <div class="product_desc_info">
                                ...
                                <h4><a class="product_name" href="{{route('product_detail',['slug'=>$value->slug,'id_detail'=>$value->id_detail])}}">{{$value->name}}</a></h4>
                                <div class="price-box">
                                    @if($value->sale_price>0)
