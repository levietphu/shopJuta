                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="copyright">Copyright &copy; <a href="{{route('home')}}">Juta</a>. VIET PHU</div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                ...
                $.ajax({
                   ...
                   success:function(data){
                    console.log(data.success);
                      $('#comment').load("http://shopjuta.epizy.com/blog_detail/co-nen-mua-nintendo-switch-hack-hay-khong #comment");
                    }
                });
                $('.comment_blog').val("");
            });
